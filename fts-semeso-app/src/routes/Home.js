        ...
        <MainContainer className="container">
            ...
            <article className="row">
                <div className="col-12">
                    ...
                    <p dangerouslySetInnerHTML={{ __html: "<b>Full Text Search</b>, <b>Text Search</b> ou simplesmente <b>FTS</b> é uma ferramenta presente no PostgreSQL e em outros SGBDs que possibilita a exploração avançada conteúdos textuais." }}/>
                    ...
                    <ul> 
                        ...
                        <li dangerouslySetInnerHTML={{__html:"Operadores de buscas textuais não fornecem uma ordem de classificação, um ranking dos resultados da pesquisa. A imagem a seguir apresenta a ordem de busca estabelecida com o auxilio do Full Text Search, supondo que a palavra pesquisada seja <i>PHP</i> num conteúdo de <i>vagas</i>, <i>tecnologia</i> e <i>postagem</i>."}}/>
                        <img src="/img/article/home/Ordem da pesquisa no BD.png" alt="Ordem da pesquisa no BD" className="d-block mx-auto mt-4 mb-4"/>
                        <li dangerouslySetInnerHTML={{__html:"Operadores de buscas tendem a serem mais lentos quando comparados com FTS por não possuírem <b>suporte a indexação</b> e realizarem sua busca em <b>todo o conteúdo do documento</b>."}}/> 
                    </ul>

                    <h2>Casos de usos</h2>
                    <p dangerouslySetInnerHTML={{__html:"O Full Text Search pode ser utilizado para melhorar a experiência de busca e navegação em grandes volumes de texto. Dito isso, é possível utilizar FTS como solução de <b>campos de buscas</b>, <b>campos auto-suggests</b>, <b>Chatbots</b>, <b>Analise e estatísticas</b>, <b>CMS</b> e etc…"}}/>
                    ...
                    <p dangerouslySetInnerHTML={{__html:"Existem muitas outras ferramentas no mercado que disponibilizam uma forma rápida de explorar conteúdos textuais. Sim, são ferramentas rápidas porém existem pontos que devem ser levados em consideração antes de utiliza-las:"}}/>
                    <ul> 
                        ...
                        <li dangerouslySetInnerHTML={{__html:"A ferramenta <b>não suportar buscas instantâneas</b>, sendo necessário realizar o download de novos dados e reindexa-los;"}}/>
                    </ul>
                    <div className="row">
                        <div className="col-6">
